...
def generate_launch_description():
    ...
    mjcf_name = LaunchConfiguration("mjcf_name", default='scene_track_link_pick_place.xml')
    ...
    # 路径规划桥接节点
    path_planning_bridge = Node(
        package="pick_place_demo",
        executable="path_planning_bridge",
        output='both'
    )
    ...
    sim_mujoco_node = Node(
        package="pick_place_demo",
        executable="sim_mujoco_pick_place_v2",
        output='both',
        parameters=[{
            'mjcf_name': mjcf_name
        }]
